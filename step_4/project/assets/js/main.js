...
var _user$project$Model1_Routing$Page2 = {ctor: 'Page2'};
var _user$project$Model1_Routing$Page1 = {ctor: 'Page1'};

var _user$project$Model1_Model$initModel = {route: _user$project$Model1_Routing$Page1};
var _user$project$Model1_Model$Model = function (a) {
	return {route: a};
};

var _user$project$Model$initialModel = F2(
	function (flags, route) {
		return {route: route, model1: _user$project$Model1_Model$initModel, flags: flags};
	});
var _user$project$Model$Model = F3(
	function (a, b, c) {
		return {route: a, model1: b, flags: c};
	});
var _user$project$Model$Flags = function (a) {
	return {socketUrl: a};
};

var _user$project$Model1_Messages$ChangeRoute = function (a) {
	return {ctor: 'ChangeRoute', _0: a};
};

var _user$project$Messages$Model1Msg = function (a) {
	return {ctor: 'Model1Msg', _0: a};
};
var _user$project$Messages$UrlChange = function (a) {
	return {ctor: 'UrlChange', _0: a};
};
var _user$project$Messages$ChangeRoute = function (a) {
	return {ctor: 'ChangeRoute', _0: a};
};

var _user$project$Layouts_Error$error = function (model) {
	return A2(
		_elm_lang$html$Html$h1,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('ERROR 404'),
			_1: {ctor: '[]'}
		});
};

var _user$project$Model1_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Model1_Views_Page1$page1 = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Model 1. Page 1'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Model1_Messages$ChangeRoute(_user$project$Model1_Routing$Page2)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('To Model 1. Page 2'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Model1_Views_Page2$page2 = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Model 1. Page 2'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Model1_Messages$ChangeRoute(_user$project$Model1_Routing$Page1)),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Model1_View$view = function (model) {
	var _p0 = model.route;
	if (_p0.ctor === 'Page1') {
		return _user$project$Model1_Views_Page1$page1(model);
	} else {
		return _user$project$Model1_Views_Page2$page2(model);
	}
};
...
var _user$project$View$view = function (model) {
	...
	switch (_p0.ctor) {
		...
		default:
			return _user$project$Layouts_Error$error(model);
	}
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"Model1Msg":["Model1.Messages.Msg"],"ChangeRoute":["Routing.Route"],"UrlChange":["Navigation.Location"]}},"Routing.Route":{"args":[],"tags":{"Home":[],"Error":[],"Model1":[]}},"Model1.Messages.Msg":{"args":[],"tags":{"ChangeRoute":["Model1.Routing.Routing"]}},"Model1.Routing.Routing":{"args":[],"tags":{"Page2":[],"Page1":[]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
